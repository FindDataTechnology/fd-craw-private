...
- [ ] 10. `bots-api.ts`: `getBotQr(id)` typing + states.
- [ ] 11. i18n strings for all new UI in en + zh-CN bundles.

## Verify

- [ ] 12. e2e (`e2e/bots-surface.spec.js`, data-testids from the spec):
  ...
  pass.
- [ ] 13. Run full fast e2e suite + `npm run web:build`; manual check
